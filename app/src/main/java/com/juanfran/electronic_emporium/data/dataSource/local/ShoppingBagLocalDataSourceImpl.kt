...
class ShoppingBagLocalDataSourceImpl(private val shoppingBagDao: ShoppingBagDao) :
    ...
    override suspend fun insertAll(products: List<ShoppingBagProductEntity>) =
        shoppingBagDao.insertAll(products)
    ...
    override suspend fun findById(id: String): ShoppingBagProductEntity =
        shoppingBagDao.findById(id)
